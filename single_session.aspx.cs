...
public partial class single_session : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        while (dae.Read())
        {
            ...
            if (dae.GetValue(7).ToString() != "")
            {
                d = d + ",designation.name";
            ...
            if (dae.GetValue(9).ToString() != "")
            {
                d = d + ",profitability.name as p";
            ...
            if (dae.GetValue(12).ToString() != "")
            {
                d = d + ",capital_raised.name as c";
            ...
            if (dae.GetValue(13).ToString() != "")
            {
                d = d + ",capital_sought.name as cc";
