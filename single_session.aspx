<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="single_session.aspx.cs" Inherits="single_session" %>
						...
						<div class="span6">
                           ...
                           <%# Eval("website").ToString() != "" ? "<a href='" + Eval("website") + "' class='btn btn-primary'>Website</a> <span class='arrow hlb hidden-phone'></span>" : Eval("website") %>
							...
							<ul class="list icons">
                                 ...
                                 <%# Eval("cc").ToString() != "" ? "<li><i class='icon-ok'></i> Capital Sought: "+ Eval("cc")+" </li>" : Eval("cc") %>
